...
$subject = "Formularz- zainteresowany kupnem: $name";
$message_body = "<b>Formularz z twojej strony www: zainteresowany kupnem</b>"."<br>";
$message_body.= "<b>Imię i nazwisko:</b> $name"."<br>";
$message_body.="<b>Numer telefonu:</b> $phone"."<br>";
$message_body.="<b>Kiedy zadzwonić:</b> $message";
